...
class ReminderNotificationUpdate : Fragment() {
    ...
    private fun updateItem(){
        ...
        val reminderEvent = EventCalendar(args.Reminder.id,3,date_begin_remind_update.text.toString().substring(0,2).toInt()
            ,date_begin_remind_update.text.toString().substring(3,5).toInt() - 1,date_begin_remind_update.text.toString().substring(6,10).toInt(),
