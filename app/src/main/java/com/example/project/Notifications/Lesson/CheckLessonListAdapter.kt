...
class CheckLessonListAdapter(
    private val ListLesson: List<String>,
    private val LVM: LessonViewModel,
    private var CL1: ArrayList<Int>,
    private var CL2: ArrayList<Int>,
    private var CL3: ArrayList<Int>,
    private val CL4: ArrayList<Int>,
    private val currentLesson: Lesson
) : RecyclerView.Adapter<CheckLessonListAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): CheckLessonListAdapter.MyViewHolder {
