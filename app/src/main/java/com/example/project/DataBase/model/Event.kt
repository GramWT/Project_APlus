...
data class Event (
        ...
        val date_notification_1:String,
        val date_notification_2:String,
        val date_notification_3:String,
        val date_notification_4:String,
        val date_notification_5:String,
